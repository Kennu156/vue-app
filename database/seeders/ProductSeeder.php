...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        $products = [
            ...
            [
                'name' => 'Viiamari',
                'description' => 'Tugev vihmavari, mis hoiab sind kuivana vihmasel ajal.',
            ...
            [
                'name' => 'Autovõtmed',
                'description' => 'Stiilne võtmehoidja, mis hoiab su võtmed korras.',
            ...
            [
                'name' => 'Kael',
                'description' => 'Elegantne kaelakee, mis sobib igale riietusele.',
